...
<script>
    tinymce.init({
        selector: 'textarea',
        plugins: 'link image imagetools paste lists table fullscreen',
        paste_as_text: true,
        toolbar: 'undo redo | bold italic underline strikethrough | fullscreen | fontselect fontsizeselect formatselect | alignleft aligncenter alignright alignjustify | outdent indent |  numlist bullist checklist | forecolor backcolor casechange permanentpen formatpainter removeformat | pagebreak | charmap emoticons | fullscreen  preview save print | insertfile image media pageembed template link anchor codesample | a11ycheck ltr rtl',
        a11y_advanced_options: true,
        tinycomments_mode: 'embedded',
        tinycomments_author: 'Spa Factory Bali',
        height: "350",
        color_cols: 5,
        color_map: [
            '16857E', 'Primary',
