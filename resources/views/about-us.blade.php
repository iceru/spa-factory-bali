<x-guest-layout>
    <div class="about__header flex flex-col p-4 lg:px-0 lg:py-8 justify-end">
        <div class="text-white container z-10 relative">
            <div class="lg:w-2/4">
                <p class="lg:text-lg">Our Message is Simple:</p>
                <div class="font-serif text-2xl lg:text-3xl">
    ...
    <div class="section">
        <div class="container grid lg:grid-cols-2 gap-4">
            <div class="p-0 lg:p-6 lg:pl-0">
                <img src="/images/about/about-1.jpg" alt="About Spa Factory Bali" />
            </div>
    ...
    <div class="section">
        <div class="container grid lg:grid-cols-2 gap-4">
            <div class="flex flex-col justify-center p-0 lg:p-4 pl-0 order-2 lg:order-1">
                <div class="font-serif text-2xl mb-3 text-primary ">
                    Empowering Women
                </div>
            ...
            <div class="p-0 lg:p-6 lg:pr-0 order-1 lg:order-2">
                <img src="/images/about/about-2.png" alt="Empowering Women" />
            </div>
        </div>
    </div>
    <div class="section">
